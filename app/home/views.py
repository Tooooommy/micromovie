...
from app.home.forms import RegistForm, LoginForm, \
    UserdetailForm, PwdForm, CommentForm
...
def user():
    ...
    if form.validate_on_submit():
        ...
        if not os.path.exists(app.config['FC_DIR']):
            ...
            os.chmod(app.config['FC_DIR'], 664)
        user.face = change_filename(file_face)
        form.logo.data.save(app.config['FC_DIR'] + user.face)
...
def animation():
    data = Preview.query.order_by(Preview.addtime.desc()).limit(4)
