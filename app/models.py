...
class User(db.Model):
    ...
    phone = db.Column(db.String(11), unique=True)  # 注册电话
...
class Userlog(db.Model):
    ...
    ip = db.Column(db.String(100))  # 会员地址
...
class Auth(db.Model):
    ...
    url = db.Column(db.String(255), unique=True)  # 地址
    addtime = db.Column(db.DateTime, unique=True, default=datetime.utcnow())  # 添加时间
...
#     admin = Admin(
#         name='Amy',
#         pwd=generate_password_hash('1111'),
#         is_super=0,
#         role_id=1
#     )
